...
EXPECTED_CAPABILITY_LOCK_SHA256='7cff427079ae1bb9f5e991fc47f6809d77cb109d1b57d869513a142161a81c12'
...
# that proves the copy unmodified. Seven of the fourteen carry non-ASCII text,
# so the project ASCII rule is relaxed for exactly those bytes, by file, by
# digest, by byte count, and by admitted code point. Nothing else is relaxed.
CAPABILITY_UNICODE_EXCEPTIONS=(
  'orca-closeout:a5396f8958f9c27cf3836f39b7dffb0d2ddda7d6b0d787792568518ef27f0d20:6'
  'orca-coordinator:0b9a65a50506b1f45ddbe0c66e3b33f05e8e358bd4341e8d2c354679f4b7c102:12'
  'orca-dry-principle:a99b79eed3ab2c1904f85dae7e5b0951a0ef065058bd5217795f957ba1f6efd6:9'
  'orca-native-mechanisms:3c7978212d9370be612f540890ca99932ef4103e74139540928ac67b0ad25f42:12'
  'orca-outcome-model:4fb1a56c869f5c81c55193a52498ef6199bf55c0a530a8ff5f38f65076be2ee7:12'
  'orca-project-profile:0d05b4147bd9a3b056ccedead1b2be3fb1cfd7a264880e2badb67b7b7c7d1c1d:6'
  'orca-verification:be0efdf694f85fc22804a46eea1d445713d2e67ade4242dff5b0972396f57993:18'
)
# The only non-ASCII code points admitted anywhere in this repository, as their
# exact UTF-8 encodings: U+2014 EM DASH and U+2019 RIGHT SINGLE QUOTATION MARK.
...
[ "${#EXPECTED_PATHS[@]}" -eq 116 ] || \
  fail 'approved repository inventory must contain exactly 116 files'
