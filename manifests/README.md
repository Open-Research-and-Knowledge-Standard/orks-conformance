...
[classify-dialect.py](../scripts/classify-dialect.py). It is the subset-scoped
gate partition. It is not a released conformance manifest and does not
authorize schema authoring.
